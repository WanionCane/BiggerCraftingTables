...
public final class TileEntityAutoHugeCraftingTable extends TileEntityAutoBiggerCraftingTable<HugeRecipe>
{
	@Override
	...
	@Nonnull
	@Override
	public AbstractRecipeRegistry<HugeRecipe> getRecipeRegistry()
	{
