...
public abstract class TileEntityAutoBiggerCraftingTable extends TileEntity implements ISidedInventory
{
	private final ItemStack[] slots = new ItemStack[getSizeInventory()];
	private final int half = (getSizeInventory() - 2) / 2;

	public abstract void recipeShapeChanged();
	...
	{
		return slot == getSizeInventory() - 1;
	}
}